...
P8B.3.1: AUTHORIZED (implementation may start)
...
P8B.3.1 — simple learned baseline implementation  AUTHORIZED
P8B.3.2 — train-only fitting on approved split    BLOCKED (until P8B.3.1 PASS)
